...
#pragma region Debug Strings
/* Included here to not clutter the .c file. This was made by just copy-pasting the enums and using VS Code's multi-line editor
   to make all the case statements at once. */
/// @brief Convert the VkFormat enum to a string value for debugging.
...
/// @brief Convert the VkPresentModeKHR to a string value for debugging.
static const char *VkPresentModeKHRToString(const VkPresentModeKHR MODE)
{
#if defined(DEBUG)
    switch (MODE)
    {
    ...
    default:
        return "VK_PRESENT_MODE_UNKNOWN_KHR";
    };
#else
    MODE;
    return "";
